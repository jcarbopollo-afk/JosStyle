...
# ⚠️ EH F19 — un solo almacén para los dos módulos, y ni un motor nuevo.
if node --import ./scripts/resolver-vite.mjs scripts/test-cuerpo-higiene-rutinas.mjs >/tmp/jc_eh19.log 2>&1; then
