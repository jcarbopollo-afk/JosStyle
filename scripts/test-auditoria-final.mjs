   ...
   --------------------------------------------------------------------------- */
{
  ...
  const sinRevisar = enDisco.filter((f) => (
    /Estilo$|EH$|perfil|rutinas|productos|recomendaciones|motor|cuerpo|manos|migracion|rendimiento|estructuraDatos|pruebasIntegrales|auditoriaFinal|coherenciaVisual|microinteracciones|experienciaReal|produccion|recuperacion|escalabilidad|iaEstilo|aprendizaje|insights|resumenPeriodico|contextual|accionesRapidas|usabilidad|seguridadEH/i.test(f)
    && f !== 'horarioEstructura'
