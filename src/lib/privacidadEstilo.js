...
export const LIBRERIAS_EH = [
  ...
  'documentacionEH', 'recuperacion', 'escalabilidad', 'iaEstilo', 'aprendizaje', 'insights', 'resumenPeriodico', 'contextual', 'accionesRapidas', 'usabilidad', 'seguridadEH', 'pruebaFinal', 'cierre',
];
