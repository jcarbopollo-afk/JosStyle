...
| 17 ✅ | BL | F2 — Libros — **hecha (v3.38.0)** | 8280 |
...
| 22 ✅ | BL | F8 — Integración y experiencia global — **hecha (v3.43.0)** 🏁 cierra BL | 11028 |
| 23 ✅ | **PR** Productividad | F1 — Rediseño completo del apartado — **hecha (v3.44.0)** | 11582 |
| 24 ✅ | PR | F2 — Hábitos — **hecha (v3.45.0)** | 11959 |
...
| 35 ✅ | NU | F3 — Configuración y objetivos nutricionales — **hecha (v3.56.0)** 🔒 la app propone, él confirma | 16496 |
| 36 ✅ | NU | F4 — Registro de comidas y consumo diario — **hecha (v3.57.0)** 🚨 un alimento ES una comida | 16835 |
| 37 ✅ | NU | F5 — Base de alimentos, personalizados y favoritos — **hecha (v3.58.0)** 🚨 los recientes se derivan | 17190 |
...
| 42 ✅ | ES | F2 — Estructura en árbol y navegación por ramas — **hecha (v3.63.0)** 🚨 las ramas son de cada área, no un catálogo global | 19030 |
| 43 ✅ | ES | F3 — Asignaturas y gestión académica — **hecha (v3.64.0)** 🚨 los temas son una lista de primer nivel, para que la papelera los vea | 19298 |
| 44 ✅ | ES | F4 — Exámenes, entregas y fechas — **hecha (v3.65.0)** 🚨 un solo registro visto desde el Home, la asignatura, el área y el Calendario | 19511 |
| 45 ✅ | ES | F5 — Apps de aprendizaje independientes — **hecha (v3.66.0)** 🚨 los objetivos son los globales: ni un sistema paralelo | 20034 |
| 46 ✅ | ES | F6 — Próximos eventos, resumen e integración final — **hecha (v3.67.0)** 🏁 **CIERRA ESTUDIOS (6/6) Y LA ENTREGA 3 (46/46)** | 20329 |

**Por dónde va:** 🏁 **46 de 46 — LA ENTREGA 3 ESTÁ CERRADA** (**PG** v3.10.0, **RA+** v3.12.0, **AR+** v3.13.0, **EC** v3.15.0, **HO+** v3.17.0, **HC F1** v3.20.0, **HC F2** v3.27.0, **HC F3** v3.28.0, **HC F4** v3.29.0, **HC F5** v3.30.0, **HC F6** v3.31.0, **HC F7** v3.32.0 ⏸, **HC F8** v3.33.0, **HC F9** v3.34.0, **HC F10** v3.36.0, **BL F1** v3.37.0, **BL F2** v3.38.0, **BL F4** v3.39.0, **BL F5** v3.40.0, **BL F6** v3.41.0, **BL F7** v3.42.0, **BL F8** v3.43.0, **PR F1** v3.44.0, **PR F2** v3.45.0, **PR F3** v3.46.0, **PR F4** v3.47.0, **PR F5** v3.48.0, **PR F6** v3.49.0, **PR F7** v3.50.0, **BN** v3.51.0, **SU F1** v3.52.0, **SU F2** v3.53.0, **NU F1** v3.54.0, **NU F2** v3.55.0, **NU F3** v3.56.0, **NU F4** v3.57.0, **NU F5** v3.58.0, **NU F6** v3.59.0, **NU F7** v3.60.0, **NU F8** v3.61.0, **ES F1** v3.62.0, **ES F2** v3.63.0, **ES F3** v3.64.0, **ES F4** v3.65.0, **ES F5** v3.66.0, **ES F6** v3.67.0). 🏁 **LOS SIETE BLOQUES CERRADOS: Hoy y Calendario (10/10), Biblioteca (8/8), Productividad (7/7), Bienestar (1/1), Sueño (2/2), Nutrición (8/8) y Estudios (6/6)** — más las cinco fases sueltas del principio (PG, RA+, AR+, EC, HO+). **No queda ninguna fase de la Entrega 3 por construir.**

⏸ **Lo que la entrega deja abierto, y no es trabajo pendiente sino decisiones de Josué:** **DEP-29**
(registrar JosStyle en Google y en Microsoft para conectar sus calendarios — el `.ics` ya funciona),
**DEP-30** (el service worker, que abre sin conexión y avisa con la app cerrada), **C-27** (al
documento le falta la fase de Notas de Biblioteca) y la autenticación de `/api/ask-ai`. Están en
`docs/03` con quién decide y cuál es el arreglo.
