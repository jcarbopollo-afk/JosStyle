...
| **Inteligencia** 🟡 | F29–F35 | Análisis por ejercicio, objetivos, consistencia, planificación semanal, sustituciones, biblioteca y calidad del catálogo — **F29 (v3.111.0) y F30 (v3.112.0) hechas; quedan F31–F35** |
