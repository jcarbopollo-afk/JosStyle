...
**Estado:** `package.json` **v3.100.0**. Vite + React 18 + Tailwind + Supabase + una función
...
**FIT F17 (v3.99.0)** y la **FIT F18 (v3.100.0)** hechas. Lo que dejaron, y que vale para las 27
que quedan:
